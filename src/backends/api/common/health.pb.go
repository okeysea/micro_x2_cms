...
func (x *QueryHealth) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*QueryHealth) ProtoMessage() {}

func (x *QueryHealth) ProtoReflect() protoreflect.Message {
	mi := &file_common_health_proto_msgTypes[0]
...
// Deprecated: Use QueryHealth.ProtoReflect.Descriptor instead.
func (*QueryHealth) Descriptor() ([]byte, []int) {
	return file_common_health_proto_rawDescGZIP(), []int{0}
}

func (x *QueryHealth) GetPing() string {
	if x != nil {
		return x.Ping
	}
	return ""
...
func (x *ResponseHealth) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ResponseHealth) ProtoMessage() {}

func (x *ResponseHealth) ProtoReflect() protoreflect.Message {
	mi := &file_common_health_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ResponseHealth.ProtoReflect.Descriptor instead.
func (*ResponseHealth) Descriptor() ([]byte, []int) {
	return file_common_health_proto_rawDescGZIP(), []int{1}
}

func (x *ResponseHealth) GetPong() string {
	if x != nil {
		return x.Pong
	}
	return ""
...
var file_common_health_proto_rawDesc = []byte{
	...
	,
...
var file_common_health_proto_goTypes = []interface{}{
	(*QueryHealth)(nil),    // 0: microx2cms.common.QueryHealth
	(*ResponseHealth)(nil), // 1: microx2cms.common.ResponseHealth
}
